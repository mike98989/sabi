...
public class Login extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tv_error_message, signupLink, forgot_password;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if(!strStatus.equals("2")){
                        ...
                        editor.putString(getString(R.string.user_faculty),jsonObject.getString("faculty"));
                        editor.putString(getString(R.string.user_department),jsonObject.getString("department"));
                        editor.putString(getString(R.string.user_school),jsonObject.getString("school"));
                        editor.putString(getString(R.string.user_token),strToken);
                        //editor.putString(getString(R.string.cookie),jsonObject.getString(""));
                        editor.putString("profile_image_url",jsonObject.getString("image"));
                        editor.commit();

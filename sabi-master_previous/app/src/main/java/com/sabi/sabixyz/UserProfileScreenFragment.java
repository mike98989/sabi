...
private TextView mFullname, mFirstName, mLastName,mPhonenumber, mEmail, mEmail2, mSchool, mFaculty, mDeparment, mChangePassword;
...
private ImageView mProfileImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSchool = view.findViewById(R.id.tv_user_school);
        mFaculty = view.findViewById(R.id.tv_user_faculty);
        mDeparment = view.findViewById(R.id.tv_user_department);
        ...
        mChangePassword = view.findViewById(R.id.tv_change_password);
        ...
        mBtnEditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, fragment).addToBackStack(null).commit();
                //fragmentManager.popBackStack("profile", androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
                //getSupportFragmentManager().popBackStack("", androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
    ...
    public void populateProfileImage() {
        ...
        if (profileImageBase64String != null && !profileImageBase64String.isEmpty()) {
            ...
            String profileImageUrl = userInfoPreference.getString("profile_img_url","");
            ...
            if (profileImageUrl != null && !profileImageUrl.isEmpty()) {
                Picasso.get().load(profileImageUrl).into(mProfileImageView, new com.squareup.picasso.Callback() {
                    ...
                    public void onSuccess() {
                        ...
                        userInfoPreference.edit().putString("base_64_string",encodedImage);
                    }

...
import com.sabi.sabixyz.helper.FilePath;
...
private EditText mFirstName, mLastName, mEmail, mPhone, mSchool, mFaculty, mDeparment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFaculty = view.findViewById(R.id.edt_user_faculty);
        mSchool = view.findViewById(R.id.edt_user_school);
        mDeparment = view.findViewById(R.id.edt_user_department);
    ...
    private void populateProfileDetails() {
        ...
        mFaculty.setText(userInfoPreference.getString(getString(R.string.user_faculty), ""));
        mDeparment.setText(userInfoPreference.getString(getString(R.string.user_department), ""));
        mSchool.setText(userInfoPreference.getString(getString(R.string.user_school), ""));
    ...
    private void submitProfileDetails() {
      if(mFirstName.getText().toString().isEmpty()){
          ...
          map.put("faculty",  mFaculty.getText().toString());
          map.put("department",  mDeparment.getText().toString());
          map.put("school",  mSchool.getText().toString());
                    ...
                    if(status.equals("1")){
                        getActivity().runOnUiThread(new Thread() {
                            ...
                            public void run() {
                                ...
                                editor.putString(getString(R.string.user_school),mSchool.getText().toString());
                                editor.putString(getString(R.string.user_faculty),mFaculty.getText().toString());
                                editor.putString(getString(R.string.user_department),mDeparment.getText().toString());
                                editor.apply();
                        ...
                        if(status.equals("1")){
                            getActivity().runOnUiThread(new Thread() {
                                ...
                                public void run() {
                                    ...
                                    editor.putString("profile_image_base_64_string",encodedImage);
                                    //editor.commit();
                                    editor.apply();
                                    ((MainActivity) getActivity()).populateProfileDetailsOnDrawer();

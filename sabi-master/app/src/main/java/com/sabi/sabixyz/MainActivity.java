...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = findViewById(R.id.fab);
        ...
        mSearch = findViewById(R.id.imgview_search_icon);
    ...
    public void populateProfileDetailsOnDrawer() {
        ...
        if (profileImageBase64String != null && !profileImageBase64String.isEmpty()) {
            ...
            String profileImageUrl = userInfoPreference.getString("profile_image_url","");
            ...
            if (profileImageUrl != null && !profileImageUrl.isEmpty()) {
                Picasso.get().load(Constants.LOCAL_PATH+profileImageUrl).into(mProfileImageView, new com.squareup.picasso.Callback() {
                    @Override
    ...
    private void get_fragment_to_display(Fragment fragmentselected) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, fragmentselected).addToBackStack(null).commit();
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*else if (id == R.id.nav_search) {
            tv_header_title.setText(R.string.menu_search);
            Fragment SearchScreenFragment = new SearchScreenFragment();
            get_fragment_to_display(SearchScreenFragment);
        }*/
